...
import { PayOrangeButton } from "@/components/pay-orange-button"
        ...
        <Card className="rounded-2xl" style={{ backgroundColor: "#FFFFFF", borderColor: "#E0D4C6" }}>
          <CardContent className="p-6 space-y-6">
            ...
            <section className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              ...
              <PayOrangeButton invoiceId={invoice.id} msisdn={invoice.customer?.phone_number} />
            </section>
          </CardContent>
        </Card>
        <p className="text-xs mt-3" style={{ color: "#10263F" }}>
          You will receive a payment approval request from Orange Money on your phone to complete the transaction.
        </p>
      </main>
    </div>
  )
